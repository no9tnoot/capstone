...
class EasySQLQuery(ISQLQuery):
    """
    Easy mySQL Query object and constructor. Implements the ISQLQuery interface. Generates an
    easy query on initialisation and stores the string, runnable query in the 'query' instance
    variable.
    """
    
    def __init__(self, database, relation=None, attribute=None, aggOrCond = None, aggFn=None):
        """
        Sets the instance variables of the easy query, and creates the string query.
        """
